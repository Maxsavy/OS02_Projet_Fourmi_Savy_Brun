...
// ====================================================================================================================
RendererVect::~RendererVect() {
    if ( m_land != nullptr )
        SDL_DestroyTexture( m_land );
}
// ====================================================================================================================
void RendererVect::display( Window& win, std::size_t const& compteur )
{
    ...
    for ( int i=0; i<m_ref_ants.numbAnts;i++) {
        win.set_pen( 0, 255, 255 );
        win.pset( static_cast<int>( m_ref_ants.pos_x[i] ), static_cast<int>( m_ref_ants.pos_y[i] ) );
    }
